...
《开发基础篇》包括第1章编程常识，第2章Java关键特性，第3章多线程，第4章JVM GC，第5章函数式编程，第6章Java协程，共六章。
...
- 第3章从多线程生命周期的厘清开始，为读者详细梳理了一番作为Java“镇教之宝”的多线程。对于大多数工程师来说，多线程既难于理解掌握，又是面试官最爱问的杀手锏问题。笔者在此深入浅出，带着读者领略多线程别样的魅力。
...
- 第6章讲解了Java中最新的协程技术。它最早随着JDK 19在JEP 425中作为预览版发布，称为Virtual Threads虚拟线程，最终JDK 21将其在JEP 444中正式确定下来。虚拟线程，即协程作为实际物理线程的映射，突破了操作系统物理线程数量的限制，而且由JDK完全控制。这样既避免了上下文切换的额外损耗，兼顾了多线程的优点，又能显著地提高应用程序的吞吐量。
